...
import cases.MedicalCheckupWithoutDBMethod;

public class MedicalCheckupWithoutDB {
    public static void main(String[] args) {
        String ResultCheckup = "";
        try {
           ...
           System.out.println("--------------------------------------------");
           // method 적용 사항입니다.
                MedicalCheckupWithoutDBMethod checkup = new MedicalCheckupWithoutDBMethod();
            checkup.methodCheckUp(ResultCheckup);
